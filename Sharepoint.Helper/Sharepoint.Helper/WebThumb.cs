...
namespace Sharepoint.Helper
{
    public class WebThumb
    {
        ...
        class Nested
        {
            ...
            internal static readonly WebThumb instance = new WebThumb();
        }

        public static WebThumb Instance
        {
            get
            {
        ...
        public Bitmap GetWebThumb(string Url, int webW, int webH, int thumbW, int thumbH)
        {
            return new WSThumb(Url, webW, webH, thumbW, thumbH).GetWSThumb();
        }
